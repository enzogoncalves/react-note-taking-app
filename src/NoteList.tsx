...
const NoteList = ({ availableTags, notes, onDeleteTag, onUpdateTag }: NoteListProps) => {
  ...
  return <>
    ...
    <EditTagsModal onUpdateTag={onDeleteTag} onDeleteTag={onDeleteTag} show={editTagsModalIsOpen} handleClose={() => setEditTagsModalIsOpen(false)} availableTags={availableTags} />
  </>
}
